...
variable "deletion_protection" {
  description = "On version 5.0.0+ of the provider, you must explicitly set deletion_protection = false and run terraform apply to write the field to state in order to destroy a cluster."
  type        = bool
  default     = false
}
