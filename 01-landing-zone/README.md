# 01-landing-zone: Terraform Project for GCP Foundation Blueprint
...
*   **`vpn`:**
    *   Creates hybrid connectivity to your on-premises networks using an optional highly available VPN. [Learn more](https://cloud.google.com/network-connectivity/docs/vpn/concepts/best-practices).
*   **`log-export`:**
